...
Run:
    python -m options_bt.strats.tsmom_grid_search --symbols ES --years 2015-2025
"""
import argparse
import itertools
...
from options_bt.domain.tsmom_backtester import TsmomBacktestConfig, load_portfolio_data, run_tsmom_backtest
